...
public class Switch1 {
	...
	public static void main(String[] args) {
		...
		case "Sunday":
			...
			break;
		case "Monday":
			System.out.println("Five more days till the weekend.");
			break;
		case "Tuesday":
			System.out.println("Four more days till the weekend.");
			break;
		case "Wednesday":
			System.out.println("Three more days till the weekend.");
			break;
		case "Thursday":
			System.out.println("Two more days till the weekend.");
			break;
		case "Friday":
			System.out.println("Only one more day till the weekend.");
			break;
		case "Saturday":
			System.out.println("It's the weekend!");
			break;
